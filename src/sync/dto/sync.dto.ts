...
export const COLLECTION_LIMITS: Record<string, { maxItems: number; maxItemSizeKB: number }> = {
  ...
  stockMovements: { maxItems: 500_000, maxItemSizeKB: 2 },
  deliveries:    { maxItems: 200_000, maxItemSizeKB: 10 },
  // Logs — large volume, small items
  activityLogs:  { maxItems: 100_000, maxItemSizeKB: 2 },
  auditLogs:     { maxItems: 100_000, maxItemSizeKB: 2 },
  systemLogs:    { maxItems: 50_000, maxItemSizeKB: 2 },
  auditTrail:    { maxItems: 100_000, maxItemSizeKB: 2 },
